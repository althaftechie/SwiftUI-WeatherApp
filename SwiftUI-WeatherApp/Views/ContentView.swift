...
//    @State private var showWeather = false // 🌟 Animation State
//
//    var body: some View {
//        ZStack {
//            BackgroundColorView(isNight: isDark)
//                .transition(.opacity)
//                .animation(.easeInOut(duration: 0.5), value: isDark) // 🌗 Smooth Mode Change
//
//            VStack {
//                Spacer()
//
...
//
//            // 🌟 Introduce Delay for Animation Effect
...
//
//            // ⚠️ Show Error Message Below TextField
